        ...
        for pd_ in pay_dates:
            ...
            rk_rows.append(
                ...
                [
                    ...
                    pd_ + timedelta(days=3),  # timely deposit
...
def generate_messy_demo():
    ...
    for ee in employees:
        ...
        for pd_ in pay_dates:
            ...
            # Base deferral and Roth pattern
            ...
            payroll_rows.append(
                ...
                [
                    ...
                    def_amount,   # deferral_pre

                    roth_amount,  # deferral_roth
            ...
            # Decide if this row is missing in RK (missing deposit)
            ...
            # Otherwise, create RK row (possibly mismatched / late)
            ...
            # Majority within 1–4 days, some 6–12 days late
    ...
    print(
        ...
        f"missing deposits: {missing_count}, late deposits: {late_count}, deferral mismatches (approx): {mismatch_count}"
...
def generate_secure20_demo():
    ...
    for ee in employees:
        ...
        for pd_ in pay_dates:
            ...
            # For non-HCEs and younger participants, add some Roth usage
            ...
            # For HCE age 50+ → force obvious "pre-tax catch-up" behavior

            if is_hce and age >= 50:

                catchup = round(np.random.uniform(120, 320), 2)

                def_amount = base_def + catchup     # inflated pre-tax

                roth_amount = 0.0                   # no Roth at all
            ...
            # RK mirrors payroll (we want Secure 2.0 issues, not RK mismatches here)
